...
class Main:
    def __init__(self, user_name, description, homepage, path_dir_pj, path_db_account, path_db_repo, path_db_license):
        self.data = Data.Data(user_name, description, homepage, path_dir_pj, path_db_account, path_db_repo, path_db_license)
